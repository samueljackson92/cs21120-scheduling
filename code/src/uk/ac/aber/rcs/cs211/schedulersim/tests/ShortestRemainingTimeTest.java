...
import uk.ac.aber.rcs.cs211.schedulersim.scheduler.ShortestRemainingTime;

public class ShortestRemainingTimeTest {

	private ShortestRemainingTime str;
	
	@Before
	public void setUp() {
		str = new ShortestRemainingTime();
	}
